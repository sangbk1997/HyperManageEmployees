...
// * Time: 11:26 AM
// */
//public class HyperCas20ServiceTicketValidator extends AbstractUrlBasedTicketValidator {
//    public static final String CAS_SERVER_URL_ALIAS = "https://casServerUrlAlias/";
//
//    /**
...
//     */
//    public HyperCas20ServiceTicketValidator() {
...
//        urlParameters.put("service", urlParameters.get("service").replace(CAS_SERVER_URL_ALIAS, virtualHost.getCallbackService()));
...
//                casSsoUrl += "/";
//            }
//            conn = new URL(validationUrl.toString().replace(CAS_SERVER_URL_ALIAS, casSsoUrl)).openConnection();
